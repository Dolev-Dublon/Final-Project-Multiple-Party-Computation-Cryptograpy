...
def Init_connection():
    ...
    server_port = 12320  # choose a port number
...
def Init_client_connection():        
    ...
    server_port = 12320  # Replace with the server's port number
...
def init_connection_apsp1():
    ...
    server_host = "0.0.0.0"  # listen on all available network interfaces
    server_port = 1239  # choose a port number
    server_socket.bind((server_host, server_port))
...
def init_connection_apsp2():
    ...
    server_host = "localhost"  # Replace with the server's IP address
    server_port = 1239  # Replace with the server's port number
